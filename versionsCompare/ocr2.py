...
# Mostrar la máscara (opcional)
cv2.imshow("Máscara Azul (cajas detectables)", mask)

# Detectar contornos
contours, _ = cv2.findContours(mask, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)

# Filtrar contornos por tamaño adecuado
cajas = []
for cnt in contours:
...
# Ordenar las cajas por posición (fila, columna)
...
# Mostrar imagen final con cajas (opcional)
...
# Imprimir solo la lista de textos en formato JSON
print(json.dumps(valores, ensure_ascii=False))
